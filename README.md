...
**The Data:** You are given a dataset that contains several variables about each shopping session. Each shopping session corresponded to a single user.

**The Purpose:** The marketing team asked you to analyze the behavior of online customers during November and December, the busiest months for shoppers.
